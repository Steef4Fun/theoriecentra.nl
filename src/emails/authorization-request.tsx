    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={box}>
          ...
          <Text style={item}>1. Ga naar <Link href="https://www.cbr.nl/nl/rijschool-machtigen.htm" style={link}>mijn.cbr.nl</Link> en log in met je DigiD.</Text>
...
// Styles (re-using styles from confirmation email)
...
const link = { color: '#221DB0', textDecoration: 'underline' };
