...
export function WhyUs() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {stats.map((stat) => (
        <Card key={stat.title} className="text-center p-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl border flex flex-col justify-center min-h-[380px]">
