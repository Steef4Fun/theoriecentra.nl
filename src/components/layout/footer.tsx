      ...
      <div className="container py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link href="/cursussen" className="text-sm hover:text-white transition-colors">Cursussen</Link></li>
            <li><Link href="/contact" className="text-sm hover:text-white transition-colors">Contact</Link></li>
            <li><Link href="/#faq" className="text-sm hover:text-white transition-colors">Veelgestelde Vragen</Link></li>
          </ul>
        </div>
        <div>
